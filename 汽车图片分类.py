...
def set_parameter_requires_grad(model, feature_extracting): # 把所有层级冻结
...
def initialize_model(model_name, num_classes, feature_extract, use_pretrained=True):
    ...
    if model_name == "resnet":
        ...
        model_ft = models.squeezenet1_0(pretrained=use_pretrained) # 把模型构造出来了
        set_parameter_requires_grad(model_ft, feature_extract)
...
print(image_datasets["train"].shape)
